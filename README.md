...
PostgreSQL gets `"id" BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY` and MySQL
`` `id` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY ``, with column types adapted per engine
