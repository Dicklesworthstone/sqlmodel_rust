...
// The builder defaults to SQLite; pass the connection's dialect for anything else
// (identifier quoting and the auto-increment key form differ per engine).
...
// )
// PostgreSQL: "id" BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
...
```toml
sqlmodel = { version = "0.4", features = ["chrono", "uuid", "decimal"] }
```
